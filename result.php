...
// Lưu lựa chọn của người chơi vào biến $choice
...
<body>
    <div id="fireworks-container"></div> <!-- Thêm div cho pháo hoa -->
    ...
    <script>
        // Chạy hiệu ứng pháo hoa nếu người chơi thắng
        document.addEventListener("DOMContentLoaded", function () {
            const result = "<?php echo $result; ?>";
            if (result === '勝ち！') { // Nếu thắng
